...
int main(int argc, char** argv)
{
	...
	GLFWwindow* window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT,
		"Demo of geometry shader(visualize normal)", NULL, NULL);
	if (!window)
	{
	...
	Shader visualNormalShader("visualNormal.vertex", "visualNormal.frag", "visualNormal.gs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniformMatrix4fv(glGetUniformLocation(visualNormalShader.programId, "projection"),
			1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(glGetUniformLocation(visualNormalShader.programId, "view"),
			1, GL_FALSE, glm::value_ptr(view));
		glUniformMatrix4fv(glGetUniformLocation(visualNormalShader.programId, "model"),
			1, GL_FALSE, glm::value_ptr(model));
		objModel.draw(visualNormalShader);
