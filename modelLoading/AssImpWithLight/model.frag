...
void main()
{
	...
	vec3	diffuse = diffFactor * light.diffuse * vec3(texture(texture_diffuse1, TextCoord));
	...
	vec3	specular = specFactor * light.specular * vec3(texture(texture_specular1, TextCoord));
